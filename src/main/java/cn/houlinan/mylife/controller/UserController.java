...
public class UserController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "email", value = "用户邮箱", required = false, dataType = "String", paramType = "form", defaultValue = "houlinan@vip.qq.com"),
            @ApiImplicitParam(name = "mobile", value = "用户手机", required = false, dataType = "String", paramType = "form", defaultValue = "17625997779"),
    })
