...
public class TeamController {
    ...
    @PostMapping("/create")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "teamName", value = "小组名称", required = true, dataType = "String", paramType = "form", defaultValue = "aaa小组"),
            @ApiImplicitParam(name = "teamPassword", value = "小组密码", required = true, dataType = "String", paramType = "form", defaultValue = "123456"),
            @ApiImplicitParam(name = "teamEmail", value = "小组邮箱", required = false, dataType = "String", paramType = "form", defaultValue = "houlinan@vip.qq.com"),
            @ApiImplicitParam(name = "isSendAllUser", value = "是否发送所有人", required = false, dataType = "String", paramType = "form", defaultValue = "1"),
    })
